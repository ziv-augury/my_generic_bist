...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_MY_SEN1_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SEN1, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_SEN1_MODULE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_MY_BOARD_1, 1);
